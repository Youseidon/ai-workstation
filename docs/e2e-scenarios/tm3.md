...
- **Phone/group:** sender bot, anchor reply, access-message identity and edits,
  command refusal, action card, allowance text, result and renewed card.
