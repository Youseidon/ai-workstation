...
| T10G | TM1 | done | `01a0af63-b4ca-7cb1-a931-7b12a8d4b920` | `tm/T10G-team-default-off` | `4cc84b8..b2de1b6` | Added the independent default-off `team.enabled` gate across settings, UI, every Team API and runtime path; personal Telegram remains available. Default-off Playwright passed 1/1, unchanged TM1 passed 3/3, combined burn-in passed 12/12, relevant server tests passed 43/43, server/web/e2e typechecks and lint passed. Final audit-rerun counts are recorded in `implementation.md`. | 2026-09-17 |
| T10E | TM1 | in progress | `01a0af94-7873-7043-b8c1-089e8dcb3f3d` | `tm/T10E-final-counts` |  | Correct the documentation-only final audit counts from 239/239 and 116/116 to the verified gated-tree totals 241/241 and 117/117. | 2026-09-17 |
