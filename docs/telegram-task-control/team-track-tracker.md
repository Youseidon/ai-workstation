...
| T03F | TM0 | blocked: verification | `01a0abf1-ded6-73c3-bc1c-f273659beff3` | `tm/T03F-harness-selftest-fix` |  | Focused self-test passed twice with loopback permission and typecheck passed; full T1 run reached the established provider tests, where `grok` was unavailable before T03F paths. No merge. | 2026-09-17 |
