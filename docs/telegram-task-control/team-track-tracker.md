...
| T03F | TM0 | blocked: verification | `01a0abf1-ded6-73c3-bc1c-f273659beff3` | `tm/T03F-harness-selftest-fix` |  | Focused self-test passed twice and typecheck passed. The T1 run and the isolated four-test inline fake-provider suite both failed because Grok is unavailable on the inline path. No merge. | 2026-09-17 |
