...
| T10G | TM1 | in progress | `01a0af63-b4ca-7cb1-a931-7b12a8d4b920` | `tm/T10G-team-default-off` |  | Add and verify the missing `team.enabled` default-off gate, then record final audit suite evidence in `implementation.md`. | 2026-09-17 |
