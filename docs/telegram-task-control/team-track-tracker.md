...
| T10G | TM1 | in progress | pending | `tm/T10G-team-default-off` |  | Add and verify the missing `team.enabled` default-off gate, then record final audit suite evidence in `implementation.md`. | 2026-09-17 |
