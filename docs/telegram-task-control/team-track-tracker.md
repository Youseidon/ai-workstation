...
| T10V | TM1 | in progress | pending | `tm/T10V-tm1-playwright` |  | Implement and burn in the missing TM-T1-1, TM-T1-1a and TM-T1-1b Playwright coverage required by T08-T10 and audit A3. | 2026-09-17 |
