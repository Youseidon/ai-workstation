...
| T10G | TM1 | done | `01a0af63-b4ca-7cb1-a931-7b12a8d4b920` | `tm/T10G-team-default-off` | `4cc84b8` | Added the independent default-off `team.enabled` gate across settings, UI, every Team API and runtime path; personal Telegram remains available. Default-off Playwright passed 1/1, unchanged TM1 passed 3/3, combined burn-in passed 12/12, relevant server tests passed 43/43, server/web/e2e typechecks and lint passed. Final audit-rerun counts are recorded in `implementation.md`. | 2026-09-17 |
