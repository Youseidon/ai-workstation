...
| T10R | TM1 | in progress | `01a0aeee-0443-7ec3-a249-3f8b7a584c36` | `tm/T10R-audit-remediation` |  | Reproduce and resolve the S-L1-04 audit timeout, then close the missing Team burn-in evidence before audit 1 is rerun. | 2026-09-17 |
