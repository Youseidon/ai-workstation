# S6-31 — Native-port estimateLines, costData, estimationDecisions, estimatorPortal
...
Namespaces: `estimateLines`, `costData`, `estimationDecisions`, `estimatorPortal`.
...
Prefer existing directories before new domain: `EstimateLineDirectory`
...
Done when: four namespace gates ALL GREEN (20+27+8+6 snapshot comparisons)
