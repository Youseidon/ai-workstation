# S6-35 — Native-port takeoff worksheet, export, presence, rfq
...
**A.** Deleting the bridge without a native handler leaves these routes returning `500 InternalError`.
...
Done when: all 11 routes green. Do not claim `--namespace takeoff` until S6-37.
