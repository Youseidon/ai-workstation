...
test("S-L1-33: a reply and a tap that arrive before their card's send returns still act on the card", covers("RTC-20, B08, B11"), async ({ harness, page }) => l1.actBeforeCardSendReturns(ctx(harness, page)));
