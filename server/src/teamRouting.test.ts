...
const cases: Case[] = [
  ...
  { name: "owner grant command reaches the owning workstation", bot: "a", text: "/grant answer", replyItemId: itemA, expected: { kind: "command", command: { command: "grant", capabilities: ["answer"] }, itemId: itemA } },
  { name: "teammate answer command reaches the owning workstation", bot: "a", sender: "202", text: "/answer Use blue", replyItemId: itemA, expected: { kind: "command", command: { command: "answer", answer: "Use blue" }, itemId: itemA } },
  { name: "grant command stays silent on the non-owner workstation", bot: "b", text: "/grant answer", replyItemId: itemA, expected: { kind: "drop" } },
  { name: "granted command addressed to another bot is ignored", bot: "a", sender: "202", text: "/resume@harness_bot_b", replyItemId: itemA, expected: { kind: "drop" } },
  { name: "unanchored granted command is dropped", bot: "a", sender: "202", text: "/context", expected: { kind: "drop" } },
